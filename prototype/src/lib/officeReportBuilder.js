/**
 * Client copy: office report sections = everything in the user's jurisdiction
 * (module access matching ROLE_PERMISSIONS).
 */
...
export function slugifyTitle(title) {
  return (
    String(title || 'office-report')
      .trim()
      .toLowerCase()
      .replace(/[^a-z0-9]+/g, '-')
      .replace(/^-|-$/g, '')
      .slice(0, 60) || 'office-report'
  )
}
